...
\chapter{Otázka VFT 1.}
	...
	\section{Sériový rezonančný obvod}
	%\vspace*{-2mm}
	\begin{itemize}[label=--]
	...
	\section{Medzné kmitočty a priepustné pásmo}
		%\vspace*{-2mm}
	\begin{itemize}[label=--]
...
\end{center}
	...
	\end{itemize}
		...
		\section{Paralelný rezonančný obvod}
	%\vspace*{-2mm}
	\begin{itemize}[label=--]
...
\end{minipage}
	...
	\section{Impedančné a výkonové prispôsobenie}
	
	\section{Činiteľ odrazu}
	\begin{figure}[H]
		\centering
	...
	\section{Podmienka impedančného prispôsobenia}
	\begin{itemize}[label=--]
	%\vspace{-2.5mm}
	...
	\section{Podmienka výkonového prispôsobenia}
	\begin{itemize}[label=--]
		%\vspace{-2.5mm}
	...
	%\vspace*{-4mm}
	\section{Prispôsobenie paralelným rezonančným obvodom a L-článkom}
	\begin{itemize}[label=--]
		%\vspace*{-2.5mm}
	...
	%\vspace{-5mm}
	\section{Vplyv pripojenia záťaže k paralelnému rezonančnému obvodu na rezonančný kmitočet a činiteľ jakosti}	
	\begin{itemize}[label=--]
		%\vspace{-2mm}
	...
	\section{Minimalizácia strát prenosu výkonu}	
	%\vspace{-2.5mm}
	\begin{itemize}[label=--]
	...
	\section{Podmienka vysokej účinnosti}	
	\begin{equation}
		Q_0 \gg Q_L
	\end{equation}
	...
	\end{itemize}
	%\vspace{-2.5mm}
	\section{Obmedzenie vplyvu záťaže}
	%\vspace{-2mm}
	\begin{itemize}[label=--]
	...
	\section{Spôsoby naviazania záťaže}
	...
	\section{Paralelný rezonančný obvod ako prispôsobovací článok}
...
{\raggedright \textbf{Vplyv strát rezonančného obvodu}}\\	
	...
	\newpage
	\section{Transformácia L článkom}
	...
	\section{Prispôsobenie záťaže pomocou L článku}
	\begin{itemize}[label=--]
	...
	\section{Viazané rezonančné obvody}
	%\vspace*{-2mm}
...
%	\newpage
	...
	\end{itemize}
	\section{Filtry se soustředěnou selektivitou}
...
\section{Směrování a řízení úrovně vf signálu}
...
%	$\abs{\Gamma_{IN}} < 1$ a zároveň $\abs{\Gamma_{OUT}} < 1$ \textbf{iba pre niektoré impedancie} pripojené na vstup alebo výstup tranzistora (pričom $\abs{\Gamma_S}<1$ a $\abs{\Gamma_L}<1$).\\
	...
	\section{Šum v aktívnych a pasívnych obvodoch}
	%\vspace{-2mm}
	...
	\section{Dynamický rozsah DR zosilňovača}
	%\vspace*{-2mm}
	...
	\newpage
	\section{Linearizovaný a veľkosignálový zosilňovač}
...
%	\section{\normalsize  Parametry směšovačů. Zpětnovazební oscilátor, podmínka oscilací. Tříbodová zapojení, přeladitelnost. Vlastnosti oscilátorů. Typy PLL syntezátoru, princip DDS, jejich spektrální vlastnosti.}
	...
	\section{Spätnoväzobné oscilátory}
	\begin{figure}[H]
		%\vspace{-2mm}
		\makebox[\textwidth]{%
...
\end{tcolorbox}
	...
	\section{Vlastnosti krystalových oscilátorov}
	...
	\section{Typy PLL syntezátoru, princip DDS, jejich spektrální vlastnosti}
	...
	%\vspace{-2mm}
	\section{Syntetizátor s celočíselným deliacim pomerom N (Integer-N):}
...
\textbf{Výstupný kmitočet:}
	...
	\medskip
	\section{Syntetizátor s neceločíselným deliacím pomerom N}
  ...
  \newpage
	...
	\section{Princíp DDS syntetizátora}
