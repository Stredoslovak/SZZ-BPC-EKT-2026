...
Stejnosměrná analýza slouží k určení \textit{pracovního bodu} obvodu, tedy stejnosměrných napětí a proudů v ustáleném stavu. 
	...
	\begin{itemize}
		\item Cívku nahradíme zkratem (induktor brání změně proudu, ale při vypuštění AC prvků je proud konstantní DC; v ideálním případě se chová jako vodič - zkrat)
	...
	\item Pracovní bod se nachází tam, kde $U_1$ = $U_2$ $\rightarrow$ v pracovním bodě musí platit $U_1$ - $U_2$ = 0, to znázorňuje graf b)
		\begin{figure}[H]
			\centering
