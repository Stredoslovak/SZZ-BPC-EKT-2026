...
Graf ukazuje, jak se mění U2/U1 s frekvencí (pro každou frekvenci se obvod spočítá znovu). Uvedený obvod je již lineární, proto se nepočítá pracovní bod jako u tranzistoru, ale rovnou se počítá přenos.
\begin{figure}[H]
	\centering
